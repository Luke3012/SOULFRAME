...
Il tentativo su più varianti di \texttt{SendMessage} non è ridondanza inutile. Serve perché i template WebGL non espongono sempre l'istanza Unity nello stesso modo; senza questa cautela il bridge diventerebbe fragile proprio nelle build che dovrebbero essere più portabili.

Anche qui non è un dettaglio cosmetico. Overlay, callback e refocus non servono soltanto a chiudere bene l'editor avatar: servono a impedire che due mondi diversi, DOM e canvas Unity, si contendano tastiera, click e stato della pagina proprio durante un passaggio delicato dell'onboarding.
