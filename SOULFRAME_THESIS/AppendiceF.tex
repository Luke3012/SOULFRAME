...
Questa appendice raccoglie alcuni materiali tecnici di supporto che aiutano a leggere meglio il comportamento del prototipo. Vi confluiscono note operative, evidenze di test e ricorrenze emerse durante le verifiche sul backend.

\section{Evidenze e pattern tecnici}
Qui confluiscono materiali diversi, ma utili per la stessa ragione: rendono più leggibili i punti in cui il prototipo lascia tracce tecniche osservabili, dai percorsi persistenti fino ai report prodotti durante le prove sul backend.

\paragraph{Store tecnici del progetto.}
Gli artefatti operativi del prototipo sono distribuiti in alcuni store distinti. Più che elencare i percorsi, qui conta capire quale funzione svolga ciascuno di essi nel ciclo di vita del prototipo.
...
Sono già disponibili evidenze tecniche prodotte durante le batterie di prova del backend. Non sono risultati di uso con utenti, ma prove utili per leggere il comportamento del backend in condizioni ripetibili. Servono a capire dove il backend recupera bene il contesto e dove, invece, la risposta finale comincia a perdere precisione o tenuta stilistica.
...
I due report richiamati qui corrispondono alla documentazione tecnica di prova associata al backend. In particolare, i conteggi riportati in questa appendice riprendono i report \texttt{SOULFRAME\_extreme\_stress\_report\_20260309\_151154.md} e \texttt{SOULFRAME\_text\_coherence\_report\_20260309\_151808.md}. Il primo raccoglie prove miste su testo, PDF e immagini; il secondo lavora solo su memoria testuale e insiste soprattutto sui casi in cui avatar e utente rischiano di essere confusi nella formulazione della risposta.
...
\captionsetup{type=table}
\captionof{table}[Sintesi dei due report tecnici più recenti]{Quadro sintetico dei risultati tecnici ricavati dai due report più recenti.}
...
Alcuni casi reali estratti dai report aiutano a leggere meglio questo scarto.
...
Questo caso mostra bene il tipo di scarto che c'è ancora nel sistema. Il documento viene trovato e il retrieval passa, ma la risposta non riesce ancora a sintetizzare il contenuto in modo abbastanza ordinato o completo da superare il controllo finale.
...
Anche la manutenzione tecnica resta un po' disomogenea. Il comportamento del backend è già osservabile con una certa continuità, ma non tutte le prove hanno ancora lo stesso grado di portabilità. La batteria di verifica aiuta a leggere regressioni e casi limite, però una parte delle prove più ricche richiede ancora una preparazione manuale degli input. Oggi questi test servono soprattutto a capire dove il sistema regge e dove no, più che a offrire un pacchetto già autosufficiente da rilanciare ovunque senza preparazione.
