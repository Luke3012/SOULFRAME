...
La Figura~\ref{fig:whisper-arch-cap2} aiuta a leggere questa scelta, mostrando la separazione tra encoder acustico e decoder testuale che sostiene l'uso del modello in pipeline conversazionali.
